...
|--------------|------|----------------|-----------------|-----------------|-------------|
| TrackedDriver1 | string | `$prop('F1ManagerPlotter.TrackedDriver1')` | N/A | N/A | The first tracked driver for dashboard highlights. |
| TrackedDriver2 | string | `$prop('F1ManagerPlotter.TrackedDriver1')` | N/A | N/A | The second tracked driver for dashboard highlights. |
| CameraFocusedOn | string | `$prop('F1ManagerPlotter.CameraFocusedOn')` | N/A | N/A | The car name the camera is focused on |
| TimeSpeed | float | `$prop('F1ManagerPlotter.TimeSpeed')` | N/A | N/A | Time fast-forward multiplicator |
| TimeElapsed | float | `$prop('F1ManagerPlotter.TimeElapsed')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].TimeElapsed` | N/A | Time elapsed in the session |
| LapsRemaining | float | `$prop('F1ManagerPlotter.LapsRemaining')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].LapsRemaining` | N/A | Laps remaining in the race |
| TimeRemaining | float | `$prop('F1ManagerPlotter.TimeRemaining')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].TimeRemaining` | N/A | Time remaining in the session |
| TrackName | string | `$prop('F1ManagerPlotter.TrackName')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].TrackName` | N/A | Track name |
| BestSessionTime | float | `$prop('F1ManagerPlotter.BestSessionTime')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].BestSessionTime` | N/A | Best time in the session |
| BestS1Time | float | `$prop('F1ManagerPlotter.BestS1Time')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].BestS1Time` | N/A | Best S1 time in the session |
| BestS2Time | float | `$prop('F1ManagerPlotter.BestS2Time')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].BestS2Time` | N/A | Best S2 time in the session |
| BestS3Time | float | `$prop('F1ManagerPlotter.BestS3Time')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].BestS3Time` | N/A | Best S3 time in the session |
| RubberState | float | `$prop('F1ManagerPlotter.RubberState')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].RubberState` | N/A | Rubber on track |
| SessionType | string | `$prop('F1ManagerPlotter.SessionType')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].SessionType` | N/A | Type of the session |
| SessionTypeShort | string | `$prop('F1ManagerPlotter.SessionTypeShort')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].SessionTypeShort` | N/A | Short type of the session |
| AirTemp | float | `$prop('F1ManagerPlotter.AirTemp')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].AirTemp` | N/A | Air temperature |
| TrackTemp | float | `$prop('F1ManagerPlotter.TrackTemp')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].TrackTemp` | N/A | Track temperature |
...
| {name}_LastS3Time | float | `$prop('F1ManagerPlotter.{name}_LastS3Time')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].LastS3Time` | `$prop('F1ManagerPlotter.'+$prop('F1ManagerPlotter.CameraFocusedOn')+'_LastS3Time')` | Last sector 3 time |
...
| {name}_rrTemp | float | `$prop('F1ManagerPlotter.{name}_rrTemp')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].RRTemp` | `$prop('F1ManagerPlotter.'+$prop('F1ManagerPlotter.CameraFocusedOn')+'_rrTemp')` | Rear right tire temp |
...
| {name}_NameOfCarAhead | string | `$prop('F1ManagerPlotter.{name}_NameOfCarAhead')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x].NameOfCarAhead` | `$prop('F1ManagerPlotter.'+$prop('F1ManagerPlotter.CameraFocusedOn')+'_NameOfCarAhead')` | Name of car ahead |
