...
| {name}_TireAge | string | `$prop('F1ManagerPlotter.{name}_TireAge')` | `JSON.parse($prop('F1ManagerPlotter.{name}.History.Lap<x>')).Turns[x]._TireAge` | `$prop('F1ManagerPlotter.'+$prop('F1ManagerPlotter.CameraFocusedOn')+'_TireAge<z')` | Current tire age |
